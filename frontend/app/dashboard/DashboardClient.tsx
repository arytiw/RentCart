...
const DashboardClient: React.FC<DashboardClientProps> = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        setItems(userItems);
        // TODO: Add API endpoint for reservations
        setReservations([]); // Temporarily empty until we create the API endpoint
      } catch (error) {
  ...
  if (loading) {
    return (
      <div className="py-20 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage your profile, listings, and bookings from here</p>
            </div>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-100">Your account details and settings</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  <FaUserTag className="text-indigo-600 text-lg" />
                  <div className="flex-1">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  <FaBirthdayCake className="text-indigo-600 text-lg" />
                  <div className="flex-1">
          ...
          <div className="p-8">
            {items.length === 0 ? (
              <div className="text-center py-12">
                ...
                <button
                  onClick={rentModal.onOpen}
                  className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-200 hover:scale-105"
                >
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-xl flex items-center justify-center">
                      <div className="flex flex-col gap-2 p-4">
                        <button
                          ...
                          className="bg-white text-gray-800 px-4 py-2 rounded-lg font-semibold flex items-center space-x-2 hover:bg-gray-100 transition-colors"
                        >
                          <FaEdit />
                          <span>Edit</span>
                        </button>
            ...
            {reservations.length === 0 ? (
              ...
              <div className="space-y-4">
                {reservations.map((reservation: any, index: number) => (
                  <div key={index} className="border-2 border-gray-100 hover:border-purple-200 rounded-xl p-6 transition-colors hover:bg-purple-50">
                    <div className="flex items-center justify-between">
                      <div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="font-semibold text-purple-600">Pending Setup</div>
                      </div>
                    </div>
                  </div>
                ))}
