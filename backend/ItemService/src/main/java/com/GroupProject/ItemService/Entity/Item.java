...
public class Item {
    ...
    public int getQuantity() {
        logger.debug("Getting quantity: {}", quantity);
        return quantity;
    }
    ...
    public Boolean getBooked() {
        logger.debug("Getting booked: {}", booked);
        return booked;
    }

    public void setBooked(Boolean booked) {
        logger.info("Setting booked: {}", booked);
        this.booked = booked;
    }

    public String getBookedBy() {
        logger.debug("Getting bookedBy: {}", bookedBy);
        return bookedBy;
    }

    public void setBookedBy(String bookedBy) {
        logger.info("Setting bookedBy: {}", bookedBy);
        this.bookedBy = bookedBy;
    }

    public String getBookingStartDate() {
        logger.debug("Getting bookingStartDate: {}", bookingStartDate);
        return bookingStartDate;
    }

    public void setBookingStartDate(String bookingStartDate) {
        logger.info("Setting bookingStartDate: {}", bookingStartDate);
        this.bookingStartDate = bookingStartDate;
    }

    public String getBookingEndDate() {
        logger.debug("Getting bookingEndDate: {}", bookingEndDate);
        return bookingEndDate;
    }

    public void setBookingEndDate(String bookingEndDate) {
        logger.info("Setting bookingEndDate: {}", bookingEndDate);
